...
do
  ...
  plot "$iter-0" using 1:(\$2+1) with lp ls 1 ps 0.33 title 'Loss Pattern 0'
  plot "$iter-1" using 1:(\$2+1) with lp ls 2 ps 0.33 title 'Loss Pattern 1'
  plot "$iter-2" using 1:(\$2+1) with lp ls 3 ps 0.33 title 'Loss Pattern 2'
